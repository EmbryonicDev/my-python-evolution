...
class GetCoin:
    ...
    def handle_bonus_text(self):
        ...
        self.get_color()
        # black if bonus_coin is not on screen, else, random color
        ...
        if self.bonus_coin.x > -1:
            ...
            pygame.draw.rect(self.window, (0, 0, 0), (self.width/2-game_text.get_width()/2, self.total_height -
                                                      self.bonus_board/2 - game_text.get_height()/2, game_text.get_width(), game_text.get_height()))
            # game text to window
            self.window.blit(game_text, (self.width*.5-(game_text.get_width()/2),
