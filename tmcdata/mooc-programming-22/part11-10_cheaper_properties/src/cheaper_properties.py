class RealProperty:
    ...
    def price_difference(self, compared_to):
        ...
        difference = abs((self.price_per_sqm * self.square_meters) -
...
def cheaper_properties(properties: list, main_property):
    return [(prop, main_property.price_difference(prop)) for prop in properties if main_property.more_expensive(prop)]
